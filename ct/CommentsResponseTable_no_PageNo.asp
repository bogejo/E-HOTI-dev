...
'     "WHERE RPId = " & iRPId
  ...
  '## Retrieve all comments to this document that the logged on user may read
  strSQL = _ 
     "SELECT C.CommentID, C.RPId, C.CommentByUserID, C.CommentByUser_Particulars, C.CommentDate, C.CommentToPlace, C.Comment, " &_
...
<tbody>
<tr>
<th valign="top" valign="top">Comm. No.</th><th valign="top">Reference</th><th valign="top">Commentator</th><th valign="top">Need update</th><th valign="top">Comment</th><th valign="top">Proposed response</th><th valign="top">Status follow up action</th>
</tr>
<%
  color = "#FFFFFF"
  fFirstPass = True
