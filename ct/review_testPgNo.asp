...
<frameset framespacing="2" frameborder="0" cols="*,480">
...
<% Else %>
  <frameset rows="*,365">
    <frame name="commentFrame" src="comments_pageNo.asp?RPId=<%= iRPId %>"
    scrolling="auto">
    <frame name="makecommentFrame" src="addComment_pageNo.asp?RPId=<%= iRPId %>"
