...
'##   txtPageNo          - (optional) The referred page no. in the hearing document - "22"(Form)
...
' Add field "CommentToPageNo" - 2015-06-22 /BGJ

Dim iRPId, strCommentByParticulars, CommentToPageNo, CommentToPlace, Comment, strSQL, txtChosenAudiences, rxRegExp
IdentifyUser
...
CommentToPageNo = ""
If Request.Form("txtPageNo") <> "" Then CommentToPageNo = dbText(Request.Form("txtPageNo"))
...
If CommentToPlace = "" Then CommentToPlace = "NULL"
' strSQL = "exec dbo.CommentsInsProc " & iRPId & ", " & dbText(strGetUserID()) & ", " & strCommentByParticulars & ", " & CommentToPlace & ", " & Comment
strSQL = "exec dbo.CommentsInsProcPgNo " & iRPId & ", " & dbText(strGetUserID()) & ", " & strCommentByParticulars & ", " & CommentToPageNo & ", " & CommentToPlace & ", " & Comment
...
' Response.Write "CommentToPageNo=" & CommentToPageNo & "<br>"        ' DEVELOPMENT & DEBUG
' Response.Write "CommentToPlace=" & CommentToPlace & "<br>"        ' DEVELOPMENT & DEBUG
