...
'		ErrorSignature = "[Need help?  Contact Lewis Moten, lewis@moten.com, http://www.lewismoten.com]"
		ErrorSignature = "[Please report errors to DNV GL 'Rules and Standards', rules@dnvgl.com]"
		...
		' AdodbVersion = CDbl(Connection.Version)  ' Commented out by BGJ 2009-11-20. Locale setting for decimal marker is inconsistent on dmz107
		Set Connection = Nothing

		If False AND AdodbVersion < 2.5 Then      ' Hardcoded 2009-11-20. The locale setting for decimal marker on dmz107 is inconsistent, so CDbl above fails
