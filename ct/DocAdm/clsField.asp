...
' BGJ 2004-09-02	AvailableSpace = FSO.GetDrive(Drive).AvailableSpace  ' Permission denied for both AvailableSpace and FreeSpace properties / BGJ 2004-09-02
		
			Set FSO = Nothing

' BGJ 2004-09-02	If AvailableSpace < DataLength Then  ' Because Permission denied for AvailableSpace and FreeSpace
			If False Then
