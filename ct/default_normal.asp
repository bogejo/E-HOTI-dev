...
iPwdDaysValid = 360   ' Max. no. of days allowed before password must be changed
bRenewPwd = False
...
<html>
<head>
<title>DNV GL Hearing on the Internet</title>
...
Else
  strSplashText = "<b><font face='Arial, Helvetica, sans-serif'>DNV GL Hearing on the Internet:</font></b><br>" & _
...
Sub CheckLoginForm
  ...
  Else
    ...
    ' response.write "strStoredPwd=" & strStoredPwd & "; txtPwd=" & txtPwd & "; " ' DEVELOPMENT & DEBUG
    ' Response.End ' DEVELOPMENT & DEBUG
